...
- (void) reset;
- (void) marbleCleared:(UIImage*) marbleImage;  ///< called if a marble color was cleared from the level - does not effect any parameter other than clearedMarbleImages
- (void) marbleRemoved:(UIImage*) removedImage; ///< call if a single marble was removed from the level - does not effect marblesInLevel!
@end
